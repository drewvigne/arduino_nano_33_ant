# Arduino Nano 33 ANT
Transforms Arduino Nano 33 BLE into ANT transceiver.
Made for ANT+ device profiles like Bike Power. 
Utilizes nRF5 SDK and S212 SoftDevice for full ANT stack support.
